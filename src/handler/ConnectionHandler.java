...
public class ConnectionHandler implements EWrapper {
    ...
    public ConnectionHandler() {
        _signal = new EJavaSignal();
        _client = new EClientSocket(this, _signal);
    }

    public boolean connect(String host, int port) {
        logger.info("Connecting to " + host + ":" + port + " ClientId: " + sClientId);
        ...
        _client.eConnect(host, port, sClientId);
        boolean status = _client.isConnected();
        if (!status) {
            logger.severe("Cannot connect to " + host + port);
            return false;
        }
    ...
    @Override
    public void error(int id, int errorCode, String errorStr) {
        logger.info("Id: " + id + " Code: " + errorCode + " Msg: " + errorStr + " " + _client.serverVersion());
    }
